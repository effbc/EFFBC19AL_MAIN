page 60190 "Material Issue"
{
    // version MI1.0,Rev01

    PageType = Document;
    SourceTable = "Material Issues Header";
    SourceTableView = WHERE("Transfer-to Code" = FILTER(<> 'DAMAGE' & <> 'STR'), "Transfer-from Code" = FILTER('STR' | 'MCH'));
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        Recipient.Add('krishnad@efftronics.com'); //B2BUPG
    ...
    var
        ...
        "Assigbtach No.s": Codeunit 60014;

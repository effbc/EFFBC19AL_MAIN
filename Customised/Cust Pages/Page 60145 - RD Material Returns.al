page 60145 "RD Material Returns"
{
    // version MI1.0,Rev01
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        CODEUNIT.RUN(60011, Rec); */ //B2B UPG <<<
            ...
            action(Refresh)
            {
                ...
                begin
                    ...
                    IF (USERID='SUPER') OR (USERID='05PD012') OR (USERID='EFFTRONICS\MARY') OR (USERID='07TE024') OR (USERID='07CS018')
                       OR (USERID='EFFTRONICS\MANILAL') OR (USERID='EFFTRONICS\SHEKHAR') OR (USERID='EFFTRONICS\SIRISHA') THEN
                    BEGIN

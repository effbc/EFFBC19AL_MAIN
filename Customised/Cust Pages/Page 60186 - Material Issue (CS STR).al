page 60186 "Material Issue (CS STR)"
{
    // version MI1.0,Rev01

    PageType = Document;
    SourceTable = "Material Issues Header";
    SourceTableView = WHERE("Transfer-to Code" = FILTER('<> STR'), "Transfer-from Code" = FILTER('CS STR'));
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Total Indent")
                {
                    ...
                    begin
                        ...
                        "Indent Header".RESET;
                        "Indent Header".INIT;
                        NoSeriesMgt.InitSeries('P-INDENT', 'P-INDENT', WORKDATE,
                                                                      Indent_No, "Indent Header"."No. Series");
                        /*NoSeriesMgt.InitSeries('P-IND1112','P-IND1112',WORKDATE,
                                                                      Indent_No,"Indent Header"."No. Series");*/
                        ...
                        "Indent Header"."ICN No." := ICNNO(WORKDATE);
                        "Indent Header"."Creation Date" := WORKDATE;
                        ...
                        END;
                        IF "Required Date" >= WORKDATE THEN
                        ...
                        REPEAT
                            ...
                            "Indent Line"."ICN No." := ICNNO(WORKDATE);
                        ...
                        IF "No. Series Line".FINDFIRST THEN BEGIN
                            ...
                            "No. Series Line"."Last Date Used" := WORKDATE;
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        IF Mat_Issue_sLine.FINDSET THEN
                            ...
                            UNTIL Mat_Issue_sLine.NEXT = 0; */ //B2B UPG <<<
            ...
            action("&Refresh")
            {
                ...
                trigger OnAction();
                begin
                    /*IF (USERID = 'EFFTRONICS\ANILKUMAR') OR (USERID = '05PD012') THEN BEGIN

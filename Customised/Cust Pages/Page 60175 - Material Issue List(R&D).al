page 60175 "Material Issue List(R&D)"
{
    // version MI1.0,Rev01

    CardPageID = "Material Issue (R&D)";
    Editable = false;
    PageType = List;
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action("&Refresh")
            {
                ...
                trigger OnAction();
                begin
                    /* IF (USERID = 'SUPER') OR (USERID = '05PD012') OR (USERID = '99P2005') OR (USERID = '07PD034')
                     OR (USERID = '10RD010') THEN BEGIN

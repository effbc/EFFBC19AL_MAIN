page 60177 "Material Damages List"
{
    // version MI1.0,Rev01

    CardPageID = "Material Damages";
    Editable = false;
    PageType = List;
        ...
        area(navigation)
        {
            group("O&rder")
            {
                ...
                action("Co&mments")
                {
                    ...
                    Image = Comment;
                    RunObject = Page 5750;
                    RunPageLink = "Document Type" = CONST("Material Issues"), "No." = FIELD("Sales Order No.");
                    ApplicationArea = All;
                }
                action("Iss&ues")
                {
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        Recipients.Add('krishnad@efftronics.com'); */ //B2B UPG

page 60192 "Material Issue List(STR)"
{
    // version MI1.0,Rev01

    CardPageID = "Material Issue";
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1000000000)
            {
                ...
                field("MaterialIssuesHeader.""Shortcut Dimension 1 Code"""; MaterialIssuesHeader."Shortcut Dimension 1 Code")
                {
                    ApplicationArea = All;
                }
            }

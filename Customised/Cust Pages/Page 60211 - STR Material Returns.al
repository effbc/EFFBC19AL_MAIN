page 60211 "STR Material Returns"
{
    // version MI1.0,Rev01
        ...
        area(navigation)
        {
            group("O&rder")
            {
                ...
                action("Co&mments")
                {
                    ...
                    Image = Comment;
                    RunObject = Page 5750;
                    RunPageLink = "Document Type" = CONST("Material Issues"), "No." = FIELD("Last Receipt No.");
                    ApplicationArea = All;
                }
                action("Iss&ues")
                {
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        // Mail_To := 'qas@efftronics.com,anilkumar@efftronics.com';
                        Recipient.Add('qas@efftronics.com');

page 60124 "Site Issues List"
{
    // version MI1.0,Rev01

    CardPageID = "Site Issues";
    Editable = false;
    PageType = List;
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        Recipients.Add('nayomi@efftronics.ne');
    ...
    begin
        ...
        ELSE BEGIN
            ...
            Recipients.Add('padmaja@efftronics.net');
            Recipients.Add('dmadhavi@efftronics.net');
            Recipients.Add('sitarani@efftronics.net');
            USER.SETRANGE(USER."User Security ID", USERID);
            IF USER.FINDFIRST THEN
                Subject := USER."User Name" + '  is trying to Delete Request ' + "No.";
            //Mail.NewCDOMessage(Mail_From, Mail_To, Subject, Body, '');

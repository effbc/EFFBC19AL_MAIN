page 60185 "Material Issue (R&D)"
{
    // version MI1.0,Rev01

    PageType = Document;
    SourceTable = "Material Issues Header";
    SourceTableView = WHERE("Transfer-to Code" = FILTER(<> 'STR'), "Transfer-from Code" = FILTER('R&D STR'));
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Total Indent")
                {
                    ...
                    begin
                        ...
                        END ELSE
                            ERROR(' THERE IS NO ITEMS TO CREATE AN INDENT');
                ...
                action("Partial Indent")
                {
                    ...
                    begin
                        ...
                        ELSE BEGIN
                            ...
                            "Indent Header"."No. Series" := 'P-IND1112';
                            "Indent Header".VALIDATE("Indent Header"."Production Order No.", "Prod. Order No.");
                            "Production Order".SETRANGE("Production Order"."No.", "Prod. Order No.");
                            // "Production Order".SETFILTER("Production Order"."Sales Order No.",'<>%1','');
                            IF "Production Order".FINDFIRST THEN BEGIN
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        Mail_To := 'krishnad@efftronics.com,anilkumar@efftronics.com';
            ...
            action("&Refresh")
            {
                ...
                begin
                    ...
                    /*
                    IF USERID IN ['EFFTRONICS\ANILKUMAR','EFFTRONICS\ANANDA','EFFTRONICS\MARY','EFFTRONICS\RATNA']  THEN
                    BEGIN

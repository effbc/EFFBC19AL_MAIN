page 60143 "Production Order Shortage Item"
{
        ...
        area(processing)
        {
            action("Create Material Request")
            {
                ...
                begin
                    ...
                    //VerifyRequest;
                    ProdOrdShortage.RESET;
                    ProdOrdShortage.SETFILTER(ProdOrdShortage."Production Order", Rec."Production Order");
    ...
    begin
        ...
        SMTP_MAIL.CreateMessage("Mail-Id"."User ID", 'erp@efftronics.com', Mail_To, Subject, Body, TRUE);

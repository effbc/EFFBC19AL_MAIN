codeunit 33000894 "Schedule Line Reserve1"
{
    ...
    var
        ...
        ResrvMgt: Codeunit "Custom Events";
        ...
        IF HasError THEN
            ...
            THEN BEGIN
                IF (NewScheduleComp."Line No." <> OldScheduleComp."Line No.") THEN BEGIN
                    ResrvMgt.SetDelChallanLine(OldScheduleComp);
                    ReservMgt.DeleteReservEntries(TRUE, 0);
                    ResrvMgt.SetDelChallanLine(NewScheduleComp);
                END ELSE BEGIN
                    ResrvMgt.SetDelChallanLine(NewScheduleComp);
                    ReservMgt.DeleteReservEntries(TRUE, 0);
                END;
    ...
    begin
        ...
        ResrvMgt.SetDelChallanLine(ScheduleComp);

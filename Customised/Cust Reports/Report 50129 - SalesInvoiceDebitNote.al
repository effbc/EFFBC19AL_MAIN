report 50129 "Sales - Invoice Debit Note"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesInvoiceDebitNote.rdl';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ModeOfTransport; "Sales Invoice Header"."Transport Method")
                    {
                    }
                    ...
                    /*column(QRCODE; EInvoiceEntry."QR Code")
                    {
                    }*/
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(formatadress_ChangeCurrency_ROUND_bedamt_1_____00_; FormatAddessNew.ChangeCurrency(ROUND(bedamt, 1)) + '.00')
                        {
                        }
                        ...
                        column(DataItem1280017; FormatAddessNew.ChangeCurrency(ROUND(LineAmt + bedamt + cessamt + ecessamt + roundoff, 1)) + '.00')
                        {
                        }
                        column(s; s)
                        {
                        ...
                        column(formatadress_ChangeCurrency__ROUND_LineAmt__Sales_Invoice_Line___Charges_To_Customer__1__ROUND_bedamt_1______00_; FormatAddressNew.ChangeCurrency(ROUND(LineAmt + 1) + ROUND(bedamt, 1)))
                        {
                        }
                        ...
                        column(DataItem1000000065; FormatAddressNew.ChangeCurrency(ROUND((ROUND(LineAmt, 1) + ROUND(bedamt, 1)) + cessamt + ecessamt, 1)) + '.00')
                        {
                        }
                        ...
                        column(DataItem1000000010; C_E__RegN__No__)
                        {
                        }
                        ...
                        column(formatadress_ChangeCurrency_ROUND_LineTotAmt_roundoff_1_____00_; FormatAddessNew.ChangeCurrency(ROUND(LineTotAmt + roundoff, 1)))
                        {
                        }
                        ...
                        column(DataItem1102152010; For_Efftronics_Systems__P__Ltd)
                        {
                        }
                        ...
                        begin
                            ...
                            */
                            ...
                            END ELSE BEGIN
                                //LineAmt := ROUND("Sales Invoice Line".Quantity * ("Sales Invoice Line"."MRP Price" * (100 - "Sales Invoice Line"."Line Discount %") / 100), 1);//Added by Pranavi on 14-OCt-2016 for MRP Pricing for LED Products//B2BUpg
                            ...
                            *///B2BUpg<<
                            ...
                            IF IsGSTApplicable THEN BEGIN
                                ...
                                IF ("Sales Invoice Header"."GST Customer Type" = "Sales Invoice Header"."GST Customer Type"::Export) AND ("Sales Invoice Header"."Posting Date" >= DMY2DATE(1, 4, 2020)) THEN BEGIN
                                    Capt12 := 'EXEMPTED FROM PAYMENT OF INTEGRATED TAX VIDE NOTIFICATION NO:37/2017 DT:4/10/17 OF CENTRAL TAX VIDE ACKNOWLEDGEMENT NO: AD370320010890K DT:31/03/2020 FROM 1/4/2020'; // added by vishnu priya on 21-08-2020
                                END;
                                ;
                            ...
                            IF Type > 0 THEN BEGIN
                                ...
                                */   // Commented by Pranavi on 20-Jan-2016 to generalize
                                ...
                                IF MRP = FALSE THEN BEGIN
                                    ...
                                    tot[k] [4] := FormatAddressNew.ChangeCurrency(ROUND(UnitPriceIncDiscnt, 0.001));
                                    Tot_1_4 := FormatAddressNew.ChangeCurrency(ROUND(UnitPriceIncDiscnt, 0.001));
                                    //tot[k][4]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Unit Price",0.001));  //commented by pranavi on 23-Dec-2015
                                END ELSE BEGIN
                                    //tot[k] [4] := FormatAddressNew.ChangeCurrency(ROUND("Sales Invoice Line".Quantity * "Sales Invoice Line"."MRP Price", 0.001));//B2BUpg
                                    //Tot_1_4 := FormatAddressNew.ChangeCurrency(ROUND("Sales Invoice Line".Quantity * "Sales Invoice Line"."MRP Price", 0.001));//B2BUpg
                                    tot[k] [4] := FormatAddressNew.ChangeCurrency((ROUND("Sales Invoice Line".Quantity, 0.001)));
                                    Tot_1_4 := FormatAddressNew.ChangeCurrency((ROUND("Sales Invoice Line".Quantity, 0.001)));
                                END;
                                //Added by Pranavi on 23-Dec-2015
                                ...
                                IF Tot_1_6 = ' 0' THEN
                                    Tot_1_6 := '';
                                IF MRP = FALSE THEN BEGIN
                                    tot[k] [5] := FormatAddressNew.ChangeCurrency(ROUND("Sales Invoice Line"."Line Amount", 1)) + '.00';
                                    Tot_1_5 := FormatAddressNew.ChangeCurrency(ROUND("Sales Invoice Line"."Line Amount", 1)) + '.00';
                                    // tot[k][6]:=FORMAT("Sales Invoice Line"."Schedule No");
                                END ELSE BEGIN
                                    /*tot[k] [5] := FormatAddressNew.ChangeCurrency(ROUND("Sales Invoice Line".Quantity * ("Sales Invoice Line"."MRP Price" * (100 - "Sales Invoice Line"."Line Discount %") / 100), 1)) + '.00';
                                    Tot_1_5 := FormatAddressNew.ChangeCurrency(ROUND("Sales Invoice Line".Quantity * ("Sales Invoice Line"."MRP Price" * (100 - "Sales Invoice Line"."Line Discount %") / 100), 1)) + '.00';
                                    tot[k] [7] := FormatAddressNew.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity * "Sales Invoice Line"."MRP Price") * ("Sales Invoice Line"."Line Discount %") / 100, 1)) + '.00';
                                    Tot_1_7 := FormatAddressNew.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity * "Sales Invoice Line"."MRP Price") * ("Sales Invoice Line"."Line Discount %") / 100, 1)) + '.00';*///B2BUpg<<
                                    tot[k] [5] := FormatAddressNew.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity * (100 - "Sales Invoice Line"."Line Discount %") / 100), 1)) + '.00';
                                    Tot_1_5 := FormatAddressNew.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity * (100 - "Sales Invoice Line"."Line Discount %") / 100), 1)) + '.00';
                                    tot[k] [7] := FormatAddressNew.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity * ("Sales Invoice Line"."Line Discount %") / 100), 1)) + '.00';
                                    Tot_1_7 := FormatAddressNew.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity * ("Sales Invoice Line"."Line Discount %") / 100), 1)) + '.00';
                                END;
                                ...
                                IF IsGSTApplicable THEN BEGIN
                                    ...
                                    Totals[7] += ROUND("Sales Invoice Line"."Amount To Customer", 1);  //pranavi
                            ...
                            */
                            ...
                            TcsAmt += GetTCSAmtLineWise("Sales Invoice Line");
            ...
            begin
                ...
                IF (("Sales Invoice Header"."GST Customer Type" = "Sales Invoice Header"."GST Customer Type"::"SEZ Development") OR
                       ("Sales Invoice Header"."GST Customer Type" = "Sales Invoice Header"."GST Customer Type"::"SEZ Unit")) THEN
                    SEZ_CAP := '(Supplies meant for SEZ under LUT without payment of IGST)'
                ELSE
                    SEZ_CAP := '';
                ...
                END ELSE BEGIN
                    ...
                    ELSE
                        IF LocationGRec.GET("Sales Invoice Header"."Location Code") THEN
                            FormatAddessNew.Location(CompanyAddr, LocationGRec);
                END;
                /*
    ...
    var
        ...
        wayb1: Text[30];
        Capt12: Text[250];
        //formatadress: Codeunit 365;
        FormatAddressNew: Codeunit "Correct Dimension Values Cust";
        TotalBody1: Boolean;
        ...
        For_Efftronics_Systems__P__Ltd: Label 'For Efftronics Systems (P) Ltd.,';
        ...
        C_E__RegN__No__: Label 'C.E. RegN. No. AAACE4879QXM001';

        ...
        field(60029; "Material Picked"; Boolean)
        {
            ...
            begin
                if "Material Picked" = false then begin
                    if not (UpperCase(UserId) in ['EFFTRONICS\SUJANI', 'EFFTRONICS\VIJAYA', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\SUVARCHALADEVI', 'EFFTRONICS\TPRIYANKA', 'EFFTRONICS\DURGAMAHESWARI']) then

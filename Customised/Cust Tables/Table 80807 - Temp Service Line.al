table 80807 "Temp Service Line"
{
    ...
    fields
    {
        ...
        field(6; "Service Item Description"; Text[130])
        {
        ...
        field(9; Type; Enum "Service Line Type")
        {
            Caption = 'Type';
        ...
        field(45; "VAT Calculation Type"; Enum "Tax Calculation Type")
        {
        ...
        field(71; "Document Type"; Enum "Purchase Document Type")
        {
        ...
        field(91; Reserve; Enum "Reserve Method")
        {
            Caption = 'Reserve';
